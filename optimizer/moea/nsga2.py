...
class NSGA2(MOEA):
    """ NSGA2: a MOEA algorithms as solver
    """
    ...
    def __init__(self, dataset: Dataset, config: Config):
        ...
        self.model_name = 'NSGA2'

    def get_algorithm(self):
        """ Return an instance of NSGA2 in pymoo library
        """
        alg = nsga2.NSGA2(pop_size=self.config['n_population'],
